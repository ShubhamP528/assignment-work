const ContactForm = () => {
  return (
    <div className="max-w-7xl h-[550px] mx-auto px-6 py-12 flex flex-col md:flex-row gap-10 justify-center  bg-cyan-50 mt-5 rounded-lg">
      {/* Form Container */}
      ...
      <div className=" p-10 rounded-lg md:w-1/2 my-auto">
